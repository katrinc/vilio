...
def get_tuple(splits: str, bs:int, shuffle
=False, drop_last=False) -> DataTuple:
...
class HM:
    def __init__(self):
        ...
        # rausgenommen katrin: self.model = self.model.cuda()
    ...
    def train(self, train_tuple, eval_tuple):
        ...
        for epoch in range(args.epochs):
            ...
            for i, (ids, feats, boxes, sent, target) in iter_wrapper(enumerate(loader)):
                ...
                # rausgenommen katrin: feats, boxes, target = feats.cuda(), boxes.cuda(), target.long().cuda()
    ...
    def predict(self, eval_tuple: DataTuple, dump=None, out_csv=True):
        ...
        for i, datum_tuple in enumerate(loader):
            ...
            with torch.no_grad():
                ...
                # rausgenommen katrin: feats, boxes = feats.cuda(), boxes.cuda()
                logit = self.model(sent, (feats, boxes))
